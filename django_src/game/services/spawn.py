import random
from main.parser import get_spawnable_species
...
def choose_wild_species():
    ...
    weights = [species.get_spawn_rate() for species in spawnable_species]
...
def determine_enemy_level(party_lucids, wild_species):
    ...
    return highest_party_level + (wild_species.get_spawn_level_offset() or 0)
